...
class ModifyContactFrame extends JFrame 
	...
	JLabel l2 = new JLabel("更新性别  ", JLabel.CENTER);
	JLabel l3 = new JLabel("更新年龄  ", JLabel.CENTER);
	JLabel l4 = new JLabel("更新电话  ", JLabel.CENTER);
	JLabel l5 = new JLabel("更新Email ", JLabel.CENTER);
	JLabel l6 = new JLabel("更新微信号 ", JLabel.CENTER);
	JLabel l7 = new JLabel("更新QQ号 ", JLabel.CENTER);
